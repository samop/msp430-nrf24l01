...
//static TLineCoding LineCoding = {9600, 0, 0, 8};
...
signed portBASE_TYPE usbserPutShort(short out, portTickType xBlockTime){
 usbserPutChar((char)(out>>8),xBlockTime);
 return usbserPutChar((char)(out&0x00FF),xBlockTime);
