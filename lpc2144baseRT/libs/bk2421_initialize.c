...
//Reg14,    Ramp curve
const U8 Bank1_Reg14[]=
{
0x41,0x20,0x08,0x04,0x81,0x20,0xCF,0xF7,0xFE,0xFF,0xFF
};

/*Bank0 register initialization value*/
const U8 Bank0_Reg[BANK0_REG_LIST_CNT][2]={
	{CONFIG,	0x0F},	//Power up, PRX
	{EN_AA,		0x01},	//Enable pipe0 auto ACK was 0x01
...
const U8 Bank0_RegAct[BANK0_REGACT_LIST_CNT][2] = {
	{DYNPD,		0x01},	//Enable pipe 0, Dynamic payload length
	{FEATURE,	0x04}	//EN_DPL= 1, EN_ACK_PAY = 0, EN_DYN_ACK = 0
};

/*The Rx Address 5 bytes*/
const U8 RX_Address[5] = { 0x3a, 0x3b, 0x3c, 0x3d, 0x01 };

/*The Tx Address 5 bytes*/
const U8 TX_Address[5] = { 0x3a, 0x3b, 0x3c, 0x3d, 0x01 };

extern volatile U8 g_TimeDelay;

/*****************************************************************************************
Function:       void DelayMs( U8 dlycnt )
Parameter: 
...
{
	volatile int cnt;
		cnt = 7100*dlycnt; //checked with osciloscope
		do (cnt--);
		while (cnt != 0);
...
*****************************************************************************************/
void SwitchCFG( U8 _cfg )//1:Bank1 0:Bank0
{
    U8 Tmp = 0;
...
/*****************************************************************************************
Function:       void RF_SetPowerMode( U8 powerdown ) 
...
//********************Write Bank0 register******************
    ...
    //reg 10 - Rx0 addr
    RF_SET_RX_ADDR( (U8 *)RX_Address );

    //REG 16 - TX addr
    RF_SET_TX_ADDR( (U8 *)TX_Address );
...
//********************Write Bank1 register******************
    ...
    SPI_Write_Buf( ( WRITE_REG|14), (U8 *)&(Bank1_Reg14[0]), 11 );
